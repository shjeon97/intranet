...
export type FindWorkRecordByUserIdQuery = { __typename?: 'Query', findWorkRecordByUserId: { __typename?: 'FindWorkRecordByUserIdOutput', ok: boolean, error?: string | null, works?: Array<{ __typename?: 'Work', date: string, id: number, startTime?: string | null, endTime?: string | null, memo?: string | null, approvalUserId?: number | null, user: { __typename?: 'User', id: number, name: string, position: string, teams: Array<{ __typename?: 'Team', level: number, name: string }> }, workStatusList?: Array<{ __typename?: 'WorkStatusList', workStatus: { __typename?: 'WorkStatus', name: string, color: string } }> | null }> | null, rests?: Array<{ __typename?: 'Rest', id: number, workId: number, startTime?: string | null, endTime?: string | null, reason?: string | null, totalMinute?: number | null }> | null } };
