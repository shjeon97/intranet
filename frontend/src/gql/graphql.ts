...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'User', email: string, name: string, phone: string, position: string, birthday: string, startDate: string, status: UserStatus, roles: Array<{ __typename?: 'Role', name: string }>, teams: Array<{ __typename?: 'Team', name: string }> } };
